...
import (
	...
	"github.com/arandich/marketplace-orders/internal/repository"
	"github.com/arandich/marketplace-orders/internal/service"
	grpcTransport "github.com/arandich/marketplace-orders/internal/transport/grpc"
	"github.com/arandich/marketplace-orders/internal/transport/http"
...
func runApp(ctx context.Context, cfg config.Config) {
	...
	services := model.Services{
		OrderService: service.NewIdService(repository.NewOrderRepository(ctx, pgPool, promMetrics, cfg, clients)),
	}
	// GRPC.
